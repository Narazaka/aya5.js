...
#ifndef POSIX
// フェータルエラー文字列（日本語）
const wchar_t	msgfj[1][128] = {
	L""
};

// エラー文字列（日本語）
const wchar_t	msgej[94][128] = {
...
// フェータルエラー文字列（英語）
const wchar_t	msgfe[1][128] = {
	L""
};

// エラー文字列（英語）
const wchar_t	msgee[94][256] = {
