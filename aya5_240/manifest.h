...
#define	AYA_VERSION				L"5.8.0.240"
...
// 演算子の名前
const wchar_t	formulatag[FORMULATAG_NUM][19] = {
	L",",   L"+",   L"-",    L"*",     L"/",
	L"%",   L"==",  L"!=",   L">=",    L"<=",
	L">",   L"<",   L"_in_", L"!_in_", L"||",
	L"&&",  L"&",   L"!",    L"++",    L"--",
...
// 制御構文
#define	FLOWCOM_NUM	14

const wchar_t	flowcom[FLOWCOM_NUM][16] = {
	L"if",
	L"elseif",
	L"else",
	L"case",
